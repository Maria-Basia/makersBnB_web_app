...
def test_constructs():
    space = Space(1, "mybnb", "in beverley hills", 9000, "2004-04-22", "2005-05-24", 2)
    assert space.id == 1
...
def test_equal():
    space1 = Space(1, "mybnb", "in beverley hills", 9000, "2004-04-22", "2005-05-24", 2)
    space2 = Space(1, "mybnb", "in beverley hills", 9000, "2004-04-22", "2005-05-24", 2)
...
def test_format():
    space = Space(1, "mybnb", "in beverley hills", 9000, "2004-04-22", "2005-05-24", 2)
    assert str(space) == "Space(1, mybnb, in beverley hills, 9000, 2004-04-22, 2005-05-24, 2)"