...
-- Finally, we add any records that are needed for the tests to run
INSERT INTO spaces (name, description, price, date_from, date_to, available_dates, user_id, image_url) VALUES ('space_1', 'description_1', 45.5, DATE '2004-04-22', DATE '2005-05-24', '{"2004-04-23", "2004-04-24", "2004-04-25"}', 1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuGLC22QwkKwitA_xtn6tuNDLNYOHpKJRvWA&usqp=CAU' );
INSERT INTO spaces (name, description, price, date_from, date_to, user_id, image_url) VALUES ('space_2', 'description_2', 14000.99, DATE '2003-03-11', DATE '2002-02-03', 2, 'https://images.unsplash.com/photo-1611622295630-7839220cf0e8?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8c2hhY2t8ZW58MHx8MHx8fDA%3D');    
